...
<head>
    ...
    <!-- Document Title-->
    <title>Privacy Policy | PlasticSpot</title>
        ...
        <div class="content-wrap">
            ...
            <div class="container clearfix">
                ...
                <div id="faqs" class="faqs">
                    ...
                    <p>PlasticSpot ("us", "we", or "our") operates the https://plasticspot.ca website (the "Service").</p>
                    ...
                    <p>PlasticSpot uses the collected data for various purposes:</p>
                    <ul>
                    ...
                    <p>PlasticSpot will take all steps reasonably necessary to ensure that your data is treated securely and in accordance with this Privacy Policy and no transfer of your Personal Data will take place to an organization or a country unless there are adequate controls in place including the security of your data and other personal information.</p>

                    <h2>Disclosure Of Data</h2>

                    <h3>Legal Requirements</h3>
                    <p>PlasticSpot may disclose your Personal Data in the good faith belief that such action is necessary to:</p>
                    <ul>
                        <li>To comply with a legal obligation</li>
                        <li>To protect and defend the rights or property of PlasticSpot</li>
                    ...
                    <ul>
                        <li>By email: plasticspotcanada@gmail.com</li>
                        <li>By visiting this page on our website: https://plasticspot.ca/support</li>
